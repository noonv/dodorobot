...
def create_conv_cvae2(channels, height, width, code_h, code_w):
	...
	x = Conv2D(16, (3, 3), activation='relu', padding='same')(x) #(input_encoded)
...
models, vae_loss = create_conv_cvae2(channels, height, width, 9, 29)
cvae = models["cvae"]
...
#cvae.load_weights('cvae_all_weights_'+str(height)+'_2.h5')
...
cvae.save_weights('cvae_all_weights_'+str(height)+'_2.h5')
